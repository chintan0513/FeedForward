...
//     try {
//       await axios.post(`http://localhost:8000/api/orders/${orderId}/place`);
...
//               <p className='w-[18%]'><strong></strong>{order.donations?.length}</p>
//               <p className='w-[26%]'><strong></strong>{order.donations[0]?.name} and more</p>
//               <p className='w-[26%]'><strong></strong>{order.createdAt}</p>
//               <button onClick={() => viewOrderDetails(order)} className='w-[12%] ' style={{ background: '#17a2b8', color: 'white', border: 'none', padding: '8px 16px', borderRadius: '5px', cursor: 'pointer', transition: 'background 0.3s', marginTop: '10px' }}>View Details</button>
//           </div>
//         ))}
//       </div>

//       {selectedOrder && (
//         <div style={{ marginTop: '20px', padding: '15px', border: '1px solid #ccc', borderRadius: '10px', backgroundColor: '#fff', boxShadow: '0 2px 5px rgba(0,0,0,0.1)', transition: 'transform 0.3s' }}>
//           <h2>Order Details</h2>
...
//               {donation.image && <img src={`http://localhost:8000/${donation.image}`} alt="Order Image" style={{ width: '100px', height: '100px', marginBottom: '10px' }} />}
//             </div>
//           ))}
//           <button onClick={() => placeOrder(selectedOrder._id)} style={{ padding: '10px', background: '#28a745', color: 'white', border: 'none', cursor: 'pointer', borderRadius: '4px', transition: 'background 0.3s' }}>Place Order</button>
//           <button onClick={() => setSelectedOrder(null)} style={{ padding: '10px', background: '#dc3545', color: 'white', border: 'none', cursor: 'pointer', borderRadius: '4px', transition: 'background 0.3s', marginLeft: '10px' }}>Cancel</button>
//         </div>
//       )}
//     </div>
//   );
